            ...
            <MDBCard className="mb-3" style={{ borderRadius: '.5rem' }}>
              <MDBRow className="g-0">
                <MDBCol md="4" className="gradient-custom text-center text-white"
                  ...
                  <MDBCardImage src={`${BASE_URL}${oprprofile.profile_picture}`}
                    alt="Avatar" className="my-5" style={{ width: '80px' }} fluid />
                  <MDBTypography tag="h5">{oprprofile.name}</MDBTypography>
                  <MDBCardText>@{oprprofile.username}</MDBCardText>
                            ...
                            <MDBCard>
                              <MDBCardBody className='px-4'>
                                ...
                                <MDBRow>
                                  ...
                                  <MDBCol md='6'>
                                  <MDBInput wrapperClass='mb-4' label='username' size='lg' id='form3' type='text' value={oprprofile.username} onChange={(e) => setOprprofile({ ...oprprofile, username: e.target.value })} />
                                ...
                                <MDBInput wrapperClass='mb-4' label='DOB' size='lg' id='form4' type='date' value={oprprofile.date_of_birth} onChange={(e) => setOprprofile({ ...oprprofile, date_of_birth: e.target.value })} />
                  ...
                  <MDBCardBody className="p-4">
                    ...
                    <MDBRow className="pt-1">
                      <MDBCol size="6" className="mb-3">
                        ...
                        <MDBCardText className="text-muted">{oprprofile.date_of_birth}</MDBCardText>
                      </MDBCol>
                      {/* <MDBCol size="6" className="mb-3">
